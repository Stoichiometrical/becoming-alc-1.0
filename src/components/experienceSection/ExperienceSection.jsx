...
import Images, {ImageMosaic} from "../image/Image";
    ...
    return(
        <>
            <div className="exContainer">
                <div className="exWrapper">OUR EXPERIENCE IN MAURITIUS</div>
                ...
                <div className="projectTxt">
                    <div className="projWrapper">
                        <ul className="projList">
                            <li className="projItem">1.2<br/> Million</li>
                            <li className="projItem">Diverse<br/>  Culture</li>
                            <li className="projItem">185<br/>  Projects Created</li>
                            <li className="projItem">27  <br/> Partners</li>
                        </ul>
